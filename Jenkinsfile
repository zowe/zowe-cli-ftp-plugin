...
node('zowe-jenkins-agent') {
    ...
    pipeline.protectedBranches.addMap([
        [name: "master", tag: "latest", level: SemverLevel.MINOR, devDependencies: ["@zowe/cli": "zowe-v2-lts", "@zowe/cli-test-utils": "zowe-v2-lts", "@zowe/imperative": "zowe-v2-lts"], aliasTags: ["zowe-v2-lts", "next"]],
        [name: "zowe-v1-lts", tag: "zowe-v1-lts", level: SemverLevel.PATCH, devDependencies: ["@zowe/cli": "zowe-v1-lts", "@zowe/imperative": "zowe-v1-lts"]]
